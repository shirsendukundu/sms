<?php
    ...
    echo "Error: failed insert" . $sql . "<br>" . mysqli_error($conn);}
...
<html>
<head>
<title>fees deposited successfully</title>
</head>
<body>
...
<!-- success msg-->
			...
			<div class="w3-panel  w3-pale-green w3-round w3-display-container w3-margin">
  				<span onclick="this.parentElement.style.display='none'"
  				class="w3-button w3-large w3-pale-green w3-midium w3-display-topright">&times;</span><br/>
				<?php echo "<center><p class='w3-large'>".$result."</p></center><br>";?>
  ...
  <!-- last 10  transaction Summary  --> 
      			...
      			<center><h3>Last 10 Transaction Summary</h3></center><br/>
...
<?php			   
	...
	?>			
			   ...
			   <center>
			   	<input class="w3-button w3-btn w3-teal w3-hover-red w3-margin-bottom"  type="submit" name="submit" value="Print Recipet"></center>
			   </form><br/>
			   </div>
			</div>
		</div>
